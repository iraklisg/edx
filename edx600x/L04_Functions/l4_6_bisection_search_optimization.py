...
print 'test case 1',findRoot3(25.0, 2, .001)
print 'test case 2',findRoot3(27.0, 3, .001)
print 'test case 3',findRoot3(-27.0, 3, .001)

print 'test case 4',findRoot3(0.25, 2, .001)
print 'test case 5',findRoot3(-0.125, 3, .001)
