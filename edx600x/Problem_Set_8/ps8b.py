...
def simulationWithDrug(numViruses, maxPop, maxBirthProb, clearProb, resistances,
    ...
    accu_total_virus_populations = [0 for i in timesteps] # initialize an array with #timesteps=300 zeros
    accu_resist_virus_populations = [0 for i in timesteps] # initialize an array with #timesteps=300 zeros
#    arxidia = []
    for trial in xrange(numTrials):
        for timestep in timesteps:
            if timestep == 150:
